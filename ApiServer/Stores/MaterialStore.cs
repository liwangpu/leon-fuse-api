...
namespace ApiServer.Stores
{
    ...
    public class MaterialStore : StoreBase<Material, MaterialDTO>, IStore<Material, MaterialDTO>
    {
        ...
        /// <returns></returns>
        public override async Task<PagedData<Material>> SimplePagedQueryAsync(PagingRequestModel model, string accid, ResourceTypeEnum resType = ResourceTypeEnum.Personal)
        {
