        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientFiles = table.Column<string>(nullable: true),
                    CreateTime = table.Column<DateTime>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    ...
                    SrcFileLocalPath = table.Column<string>(nullable: true),
                    SrcFileMd5 = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FolderId = table.Column<string>(nullable: true),
                    GeoPos = table.Column<string>(nullable: true),
                    Icon = table.Column<string>(nullable: true),
                    ModifyTime = table.Column<DateTime>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    OrganizationId = table.Column<string>(nullable: true),
                    PlanImageScale = table.Column<int>(nullable: false),
                    PlanImageUrl = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Icon = table.Column<string>(nullable: true),
                    LateralPath = table.Column<string>(nullable: true),
                    ModifyTime = table.Column<DateTime>(nullable: false),
                    Name = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mesh = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[ProductSpecId] IS NOT NULL");
